        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Instrucciones = table.Column<string>(type: "nvarchar(max)", maxLength: 15000, nullable: false),
                    ...
                    Porciones = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    EstaPublicado = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreadoUtc = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    ModificadoUtc = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Raitings_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Raitings_Recetas_RecetaId",
                        column: x => x.RecetaId,
                        principalTable: "Recetas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Raitings_RecetaId",
                table: "Raitings",
                column: "RecetaId");

            migrationBuilder.CreateIndex(
                name: "IX_Raitings_RecetaId_UsuarioId",
                table: "Raitings",
                columns: new[] { "RecetaId", "UsuarioId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Raitings_UsuarioId",
                table: "Raitings",
                column: "UsuarioId");
